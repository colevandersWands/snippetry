/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+json+python+scheme+yaml&plugins=autolinker+match-braces */
var _self =
            ...
            e.content
              ...
              .replace(/&(\w{1,8}|#x?[\da-f]{1,8});/gi, function (n, e) {
                ...
                return '#' === (e = e.toLowerCase())[0]
                  ? ((t = 'x' === e[1] ? parseInt(e.slice(2), 16) : Number(e.slice(1))),
                    l(t))
                  : o[e] || n;
              }),
            p,
