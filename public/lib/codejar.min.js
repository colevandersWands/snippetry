...
export function CodeJar(t, e, n = {}) {
  ...
  function T(e) {
    ...
    w(t, (t) => {
      ...
      if (d + n > e.start && (o || ((o = t), (i = e.start - d)), d + n > e.end))
        return (r = t), (s = e.end - d), 'stop';
      d += n;
    }),
      o || ((o = t), (i = t.childNodes.length)),
      r || ((r = t), (s = t.childNodes.length)),
      '<-' == e.dir && ([o, i, r, s] = [r, s, o, i]),
      n.setBaseAndExtent(o, i, r, s);
  }
  function b() {
    const e = H().getRangeAt(0),
      n = i.createRange();
    return (
  ...
  function k() {
    ...
    if (o && o.html === e && o.pos.start === n.start && o.pos.end === n.end)
      return;
    c++, (a[c] = { html: e, pos: n }), a.splice(c + 1);
        ...
        o.addClosing &&
          (function (t) {
            const e = '([{\'"',
              ...
              s = o.substr(0, 1);
            if (n.includes(t.key) && !i && s === t.key) {
              const e = N();
              _(t), (e.start = ++e.end), T(e);
            } else if (
              e.includes(t.key) &&
              !i &&
              ('"\''.includes(t.key) || ['', ' ', '\n'].includes(s))
              ...
              _(t);
              const o = N(),
                r = o.start == o.end ? '' : H().toString();
              S(t.key + r + n[e.indexOf(t.key)]), o.start++, o.end++, T(o);
            }
          })(e),
        o.history &&
          (!(function (e) {
