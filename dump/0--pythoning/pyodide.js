  ...
  var f = (t, e) => _(t, 'name', { value: e, configurable: !0 }),
    g = ((t) =>
      typeof require < 'u'
        ? require
        : typeof Proxy < 'u'
        ? new Proxy(t, { get: (e, c) => (typeof require < 'u' ? require : e)[c] })
        : t)(function (t) {
    ...
    M = (t, e, c, o) => {
      if ((e && typeof e == 'object') || typeof e == 'function')
        for (let a of de(e))
          !ue.call(t, a) &&
            a !== c &&
            _(t, a, { get: () => e[a], enumerable: !(o = le(e, a)) || o.enumerable });
      return t;
    };
  var h = (t, e, c) => (
      (c = t != null ? ce(fe(t)) : {}),
      M(e || !t || !t.__esModule ? _(c, 'default', { value: t, enumerable: !0 }) : c, t)
    ),
...
`),
              ...
              var p = u.exec(i[l]);
              p && s.push(new e({ fileName: p[2], lineNumber: p[1], source: i[l] }));
            }
            return s;
...
`,
            ...
            return u.map(function (i) {
              ...
              var y =
                d === void 0 || d === '[arguments not available]' ? void 0 : d.split(',');
              return new e({
                functionName: p,
                args: y,
                fileName: l[0],
  ...
  async function Q() {
    ...
    if (H) {
      ...
      return (await import(/* webpackIgnore */ 'url')).fileURLToPath(o.dirname(e));
    }
      ...
      a = {
          ...
          for (let [i, s] of u)
            i !== '.' &&
              (n[o.join2(r.mountpoint, i)] = {
                timestamp:
                  s.kind === 'file' ? (await s.getFile()).lastModifiedDate : new Date(),
        ...
        reconcile: async (r, n, u) => {
          ...
          Object.keys(n.entries).forEach(function (p) {
            let d = n.entries[p],
              y = u.entries[p];
            (!y || (e.isFile(d.mode) && d.timestamp.getTime() > y.timestamp.getTime())) &&
              (s.push(p), i++);
          }),
            s.sort();
          let l = [];
  ...
  var _e = f(async (t) => {
    let e = [];
    async function c(a) {
      for await (let r of a.values()) e.push(r), r.kind === 'directory' && (await c(r));
    }
  ...
  function te(t, e) {
    let c;
    e.stdLibURL != null ? (c = e.stdLibURL) : (c = e.indexURL + 'python_stdlib.zip'),
      Ne(t, c),
      Se(t, e.env.HOME),
      Oe(t, e.env),
      ke(t, e._node_mounts),
  ...
  async function T(t = {}) {
    ...
    if (
      ((a.locateFile = (s) => o.indexURL + s), typeof _createPyodideModule != 'function')
    ) {
      let s = `${o.indexURL}pyodide.asm.js`;
      await S(s);
    }
    if ((await _createPyodideModule(a), await n, a.exited)) throw a.exited.toThrow;
    if ((t.pyproxyToStringRepr && r.setPyProxyToStringMethod(!0), r.version !== b))
      throw new Error(
